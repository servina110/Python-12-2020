...
class Clothes:
    ...
    def fabric_consumption(self):
        return str(f'Суммарный расход ткани: {(self.coat / 6.5 + 0.5) + (2 * self.costume + 0.3) :.2f} ')


class Coat(Clothes):
    @property
    def fabric_consumption(self):
        return str(f'Для производства пальто необходимо: {self.coat / 6.5 + 0.5 :.2f} ткани')


class Costume(Clothes):
    @property
    def fabric_consumption(self):
        return str(f'Для производства костюма необходимо: {2 * self.costume + 0.3 :.2f} ткани')
