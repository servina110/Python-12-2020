...
print("Сложение переменных (a + b) = ", a + b)
print("Вычитание переменных (a - b) = ", a - b)
print("Умножение переменных (a * b) = ", a * b)
print("Деление переменных (a / b) = ", a / b)
print("Целочислительное деление переменных (a// b) = ", a // b)
print("Остаток от деления переменных (a % b) = ", a % b)
print("Возведение в степень переменных (a ** b) = ", a ** b)
print("ЗАПРОС У ПОЛЬЗОВАТЕЛЯ:")
number1 = int(input("Введите первое число >>> "))
string1 = input("Введите первую строку >>> ")
number2 = int(input("Введите второе число >>> "))
string2 = input("Введите вторую строку >>> ")
print("Введеные значения - %5d %10s %5d %10s" % (number1, string1, number2, string2))

# Задача-2. Пользователь вводит время в секундах. Переведите время в часы, минуты и секунды и выведите в формате чч:мм:сс.
...
# Задача-3. Узнайте у пользователя число n. Найдите сумму чисел n + nn + nnn. Например,
